...
def attention_unit(input_layer, skip):
    ...
    """
    This is to construct the Attention Module applying the mixed attention, the structure is shown as:
...
def attention_unit_ca(input_layer, skip):

    """
    This is to construct the Attention Module applying the channel attention, the structure is shown as:
    ...
    out_mask = Conv2D(input_channel, (1, 1))(out_mask) # shape: (batch_size,height, width, n_channel)
    out_mask = Conv2D(input_channel, (1, 1))(out_mask) # shape: (batch_size,height, width, n_channel)
    out_mask = tf.math.l2_normalize(out_mask, axis=-1) # shape: (batch_size,height, width, n_channel)
...
def attention_unit_sa(input_layer, skip):

    """
    This is to construct the Attention Module applying the spatial attention, the structure is shown as:
    ...
    out_mask = Conv2D(input_channel, (1, 1))(out_mask) # shape: (batch_size,height, width, n_channel)
    out_mask = Conv2D(input_channel, (1, 1))(out_mask) # shape: (batch_size,height, width, n_channel)
    out_mask = tf.keras.layers.LayerNormalization(axis=-1)(out_mask)
    out_mask = Activation('sigmoid')(out_mask)         # shape: (batch_size,height, width, n_channel)
